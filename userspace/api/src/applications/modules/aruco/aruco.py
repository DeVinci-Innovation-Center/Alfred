...
def take_picture(camera_feed: str, name: str = "image"):
...
def take_pictures(camera_feed: str = WIN_NAME, dirpath: str = DIRPATH, nbr_pic: int = 1) -> None:
...
def get_calibration_coef(dirpath: str = DIRPATH) -> Any:
    square_size = 0.025

    #take_pictures(dirpath, 20)
    _, mtx, dist, _, _ = calibrate(dirpath, square_size)
