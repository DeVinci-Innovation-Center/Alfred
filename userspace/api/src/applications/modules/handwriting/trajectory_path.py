...
class TrajectoryPath:
    def __init__(self, path: svgpathtools.path.Path, cartesian_equation: Tuple[float], z_height: float, nb_points: int = 2) -> None:
        self.path = path
...
class TrajectoryPaths:
    def __init__(self, file_path: str, cartesian_equation: Tuple[float] = [0, 0, 1, -250], z_height: float = .0, svg_scale: float = 0.5, nb_points: int = 2) -> None:
    ...
    def svg_to_paths(self) -> None:
        ...
        for element in paths:
            ...
            self.list_path.append(TrajectoryPath(
